...
func (o *Orchestrator) MonitorLoop() {
	...
	for range ticker.C {
		RLockOrchestrator(o, "MonitorLoop")
		instances := make([]*AceStreamInstance, 0, len(o.instances))
		for _, inst := range o.instances {
			instances = append(instances, inst)
		}
		RUnlockOrchestrator(o, "MonitorLoop")
...
func (o *Orchestrator) MarkStreamStalled(inst *AceStreamInstance) {
	LockOrchestrator(o, "MarkStreamStalled "+inst.Name)
	defer UnlockOrchestrator(o, "MarkStreamStalled "+inst.Name)
...
func (o *Orchestrator) ResetStreamFailures(inst *AceStreamInstance) {
	LockOrchestrator(o, "ResetStreamFailures "+inst.Name)
	defer UnlockOrchestrator(o, "ResetStreamFailures "+inst.Name)
...
func (o *Orchestrator) killAndReplace(inst *AceStreamInstance) {
	LockOrchestrator(o, "killAndReplace "+inst.Name)
	delete(o.instances, inst.ContainerID)
	remaining := len(o.instances)
	UnlockOrchestrator(o, "killAndReplace "+inst.Name)
